...
from model import cbow_forward, get_loss, rnn_forward, attention_forward, attention_LSTM_forward
...
class Run(object):
    ...
    def _pipeline(self, config, inputs):
        ...
        elif config.model == 'att_lstm':
            model_func = attention_LSTM_forward
